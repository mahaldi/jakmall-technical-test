...
lalu pada payment step 1 error handling mengikuti seperti yang ada pada 
contoh mockup yaitu tidak memunculkan tulisan error hanya merubah icon dan warna dari field form. 
pada step ke 2 saya menambahkan validasi tambahan jika menggunakan e wallet dan total 
harga melebihi e wallet, untuk itu silahkan menggunakan metode pembayaran yang lain. 
pada form ke 2 tidak ada pesan error juga dan sudah ada initial value yang di pilih. 
karena jika tidak ada initial value saya bingung bagaimakan menampilkan 
tulisan error yang proper tanpa perlu menampilkan tulisan error. 
